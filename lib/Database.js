...
/*
	first(sql, param, callback, context){
		...
		this.query(sql, param, function(err, data){
			if(typeof callback === 'function')
				callback.call(context||this, err, data.length?data[0]:null);
		})
	}
*/
...
/*
	value(sql, param, callback, context){
		...
		this.first(sql, param, function(err, data){

			if(typeof callback === 'function')
				callback.call(context||this, err, err?null:_.first(_.values(data)));
		})
	}
*/
...
/*
	values(sql, param, callback, context){
		...
		this.query(sql, param, function(err, data){
			...
			_.each(data, function(item){
				...
				result.push( vals.length == 1 ? vals[0] : vals );
			})
...
/*
	keyValue(sql, param, callback, context){
